    ...
    <body>
                ...
                <div class="top-links">
                    <div class="container">
                        <ul class="row links">
                            ...
                            <li class="col-xs-12 col-sm-4 link-item active"><span>3</span><a href="checkout.php"></a></li>
                            <li class="col-xs-12 col-sm-4 link-item active"><span>4</span><a href="checkout.php">Order and
                                    Pay</a></li>
                        </ul>
                    </div>
                </div>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="payment-option">
                                                ...
                                                <p class="text-xs-center"> <input type="submit"
                                                        onclick="return alert confirm('Do you want to confirm the order?');"
                    ...
                    <div class="widget-body">
                        ...
                        foreach ($_SESSION["cart_item"] as $item) {
                            ...
                            <div class="form-group row no-gutter">
                                <div class="col-xs-8">
                                    <input type="text" class="form-control b-r-0" value=<?php echo "₹" . $item["price"]; ?>
        ...
        <div class="container m-t-30">
            <form action="" method="post">
                ...
                // Query to fetch the address for the logged-in user
                ...
                if ($result) {
                    ...
                    $location = "Address not found"; // Or any appropriate error message
                }
                ?>
                <!-- New section to capture user's location -->
                    ...
                    <div class="widget-body">
                        ...
                        <div class="payment-option">
                            ...
                            <p class="text-xs-center">
                                ...
                                <input type="submit" onclick="return confirmLocation();" name="submit"
                                    class="btn btn-success btn-block" value="Confirm Location and Order Now">
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <script>
            // Function to confirm the location before placing the order
            function confirmLocation() {
                ...
                // You can add further validation for the location if needed
                return confirm("Are you sure you want to confirm the order with the location: " + location + "?");
            }
        </script>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address</h5>
                            <p>Minar Regency, Mumbra-400612</p>
                            <h5>Phone: 9867557309</a></h5>
                        </div>
